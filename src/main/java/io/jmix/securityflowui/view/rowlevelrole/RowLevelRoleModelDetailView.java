...
@Route(value = "rowlevelrolemodels-test/:code", layout = DefaultMainViewParent.class)
@UiController("sec_RowLevelRoleModel.detail1")
@UiDescriptor("row-level-role-model-detail-view-test.xml")
@EditedEntityContainer("roleModelDc")
@PrimaryDetailView(RowLevelRoleModel.class)
public class RowLevelRoleModelDetailView extends StandardDetailView<RowLevelRoleModel> {
    ...
    private void rowLevelPoliciesTableRemoveAfterActionPerformedHandler(AfterActionPerformedEvent<RowLevelPolicyModel> event) {
